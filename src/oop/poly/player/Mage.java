...
//        if(this.mana < 30) {
//            System.out.println(this.nickName + "의 마나가 부족하여 스킬이 취소됩니다");
//        } else {
//            System.out.println(this.nickName + "님이 눈보라 시전!!");
//            this.mana -= 30;
...
//
//                    if(target.hp <= 0) {
//                        System.out.println(target.nickName + "님의 체력이 전부 소모되어 사망하였습니다.");
//                    }
//                }
//            }
//        }
